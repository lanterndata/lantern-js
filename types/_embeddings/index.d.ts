...
type ImageEmbeddingModels = {
  CLIP_VIT_B_32_VISUAL: 'CLIP_VIT_B_32_VISUAL';
};

type OpenAITextEmbeddingModels = {
  ADA_002: TextEmbeddingModels.OPENAI_ADA_002;
};

type CohereTextEmbeddingModels = {
...
declare const TextEmbeddingModels: TextEmbeddingModels;
declare const ImageEmbeddingModels: ImageEmbeddingModels;
declare const OpenAITextEmbeddingModels: OpenAITextEmbeddingModels;
declare const CohereTextEmbeddingModels: CohereTextEmbeddingModels;
